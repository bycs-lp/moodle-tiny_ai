...
$string['imagetotext_baseprompt'] = 'Transcribe the image content exactly as it appears. Return only the raw content — no descriptions, commentary, or interpretation. Use LaTeX notation with $$...$$ delimiters for any mathematical formulas.';
...
$string['pluginname_userfaced'] = 'Basic editor tools';
...
$string['purposeplacedescription_freeinputtextarea'] = 'free input text area above the tool grid';
$string['purposeplacedescription_toolprefix'] = 'tool "{$a}"';
